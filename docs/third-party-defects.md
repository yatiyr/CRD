...
| Hosted evidence | [Run 34757652779](https://github.com/yatiyr/CRD/actions/runs/34757652779) at `ae44264`: `win-asan` fails exactly the four registered names, census `driver=10.0.26100.33296`, four reads 0 bytes past D3D12Core regions of 2,568, 2,924, 2,924 and 3,788 bytes; every other lane green |
