...
| 3.0   Scene / ECS foundation    | 🚧 active (v1a–v1l shipped; v1m–v1p remaining) | `docs/phases/phase-3.0-scene-ecs.md` (8-layer slot architecture; **17 slices** — expanded 2026-05-08 to land Öbek + Preset + Profile authoring substrate inside Phase 3.0; ADRs 0049–0057 locked 2026-05-06; **ADRs 0058 (Öbek) / 0059 (Preset) / 0060 (Profile) locked 2026-05-08**) |
