...
- **Phase 3.1.7 `crd-geometry` — 7 of 11 sub-modules COMPLETE** (51 of 49 renewed-scope slices shipped, 104%): `-primitives` ✅ v0a–v0f + v1h (2026-05-13) + `-bvh` ✅ v1a–v1g (2026-05-13) + `-convex` ✅ v2a–v2j + v2-close + v3 Shewchuk-predicates + hull-extension + simplify (2026-05-14/15) + `-mesh` ✅ v4a–v4d + v4-validate + v4-close (2026-05-16) + `-spatial` ✅ v5a–v5e + thread-safety pass + scene-index bringup + queries-extension + v5-close (2026-05-16) + `-polygon` ✅ v6a–v6e + v6-close (2026-05-16) + `-viz` ✅ v1j companion module. ADR-0076 §12+§13+§15+§16+§17+§18+§19+§20+§21 amendments all accepted. 18-config full sweep PASS at each cluster close
