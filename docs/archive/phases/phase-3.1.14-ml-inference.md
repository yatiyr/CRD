...
> Historical exclusion, superseded 2026-09-12: [ADR-0130](../../decisions/0130-system-qualification-and-agent-driven-products.md)
> requires inference and training to qualify together; custom CEIR/CKIR kernel authoring is central.
> [AI](../../ROADMAP.md#slice-ai) and [ML-DOMAIN.5](../../ROADMAP.md#slice-ml-domain.5) retain ownership.
