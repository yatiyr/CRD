...
> **2026-09-11 review note:** this inventory describes the August pre-CEIR-hardening source snapshot.
> RAH-1a.1 and CEIR-14…35 changed that source. The [September audit](../../research/2026-09-12-system-audit.md)
> records current-tree corrections; the [execution contract](../../design/renderer-ui-execution-contract.md#rah-completion)
> and [master table](../../ROADMAP.md#slice-rah-0) preserve the complete RAH-1…8 obligations. RAH-0 remains pending review. Refresh the field/consumer/no-loss census before migration;
> do not treat the old line numbers, 14-executor count or visbuffer fields below as current code.

> **Band:** RAH (Render Architecture Hardening), post-RAF programme — see `docs/archive/D-007-gpu-program-system.md`
