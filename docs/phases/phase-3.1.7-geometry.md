...
**Total: ~33 slices, ~18.5 KLOC engine + ~5 KLOC editor-tier + ~4 KLOC
cooker-emitted GLSL/HLSL, ~6–8 months calendar** (was 25 / 14 + 5 /
...
also nets ~−0.4 KLOC out of `crd-math` into v0a).
