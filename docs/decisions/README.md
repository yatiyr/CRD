...
| 0078  | `crd-units` substrate (dimensional types + 6-layer conversion system); §2 amendment 2026-05-15 (v0b adoption A — Vec<Quantity>, crd-config accessors, scene::Transform, glTF cook position_scale, 5-config DoD) | arch, substrate, units, dimensional-analysis, type-safety, determinism                       | Accepted  |
