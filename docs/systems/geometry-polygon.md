...
[Module manifest](../../engine/geometry-polygon/CMakeLists.txt); [Current module/source map](../systems/README.md).
Full technical requirements and dated evidence: [preserved reference](../archive/systems/geometry-polygon.md).
