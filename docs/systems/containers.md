...
[Module manifest](../../engine/foundation/containers/CMakeLists.txt); [Current module/source map](../systems/README.md).
Full technical requirements and dated evidence: [preserved reference](../archive/systems/containers.md).
