...
//
// Identical renderer to the regression gate (tests/gpu/kir/hair_render.hpp) — same groom kernel, same Chiang BCSDF kernel,
...
//
// ⭐ WHY THIS FILE LIVES HERE AND NOT IN tests/gpu/kir. The KIR test target deliberately does NOT link Vulkan — that is the
