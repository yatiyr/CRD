// tests/gpu/kir-cuda/test_autotune_cuda.cpp — ADR-0098 §4 · AS-1b: the CKIR auto-scheduler MEASURED SEARCH LOOP (CUDA).
//
...
// everywhere. Feature-detect must be preprocessor (mirrors engine/foundation/memory/src/virtual_memory_allocator.cpp).
