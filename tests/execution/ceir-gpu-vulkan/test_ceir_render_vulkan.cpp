...
// tests/execution/ceir-gpu/test_execute.cpp (14z-1/14z-2); here it drives real pixels.
...
#include "../../gpu/gpu-shared/ceir_render_triangle.hpp" // the SHARED CEIR render program + the executor wrapper
#include "../../gpu/gpu-shared/ckir_raster_triangle.hpp" // the SHARED CKIR triangle geometry (build_triangle_vs/fs) + build_gbuffer_two_output_fs
#include "../../gpu/gpu-shared/ckir_vertex_pull.hpp"     // CEIR-14z-4c: build_vertex_pull_vs (the storage-pull VS for the MRT proof)
