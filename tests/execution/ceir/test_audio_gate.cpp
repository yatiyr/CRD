...
#include <fstream> // slurp the committed audio .ceir asset (inline, mirroring test_dist_gate.cpp -- device-free tests/execution/ceir
                   // never reaches into the tests/gpu/gpu-shared reader, a real layer boundary)
...
// tests/execution/ceir slurps inline -- NO reach into the tests/gpu/gpu-shared reader, a real layer boundary.)
