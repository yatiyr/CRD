...
// `create_pipeline_from_cuda` → `cuLaunchKernel`'s blockDim (engine/gpu/gpu-context-cuda). ⛔ single-workgroup add/reduce/scan
...
#include "../../gpu/gpu-shared/ckir_kernel_dispatch.hpp"
