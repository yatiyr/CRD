...
#include "../../gpu/gpu-shared/ceir_asset_slurp.hpp"   // CEIR-30c-2b: slurp_asset — the shared committed-asset reader (the place_mesh.ceir loader)
#include "../../gpu/gpu-shared/ckir_asset_resolve.hpp" // CEIR-30b-2b-2b: resolve_ckir_asset — the shared VizDispatch .ckir loader
#include "../../gpu/gpu-shared/two_class_fixture.hpp"  // CEIR-30b-2b-2b: fill_two_class_sandwich — the ONE oracle body
...
// CEIR-30b-2b-2b: the two-class fill+oracle body was HOISTED to `tests/gpu/gpu-shared/two_class_fixture.hpp`
