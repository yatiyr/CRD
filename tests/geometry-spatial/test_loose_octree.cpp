          ...
          "[geometry-spatial][octree][overlap][concurrent][jobs]")
{
    ...
    for (u32 q = 0; q < OctreeConcurrencyCorpus::k_queries; ++q)
    {
    ...
    constexpr u32 total_tasks = OctreeConcurrencyCorpus::k_queries * OctreeConcurrencyCorpus::k_iters_per_query;
    ...
    crd::jobs::Counter* counter = crd::jobs::parallel_for(
        ...
        [corpus_ptr](crd::u32 begin, crd::u32 end) noexcept {
            ...
            {
                const u32 q = task_idx % OctreeConcurrencyCorpus::k_queries;
