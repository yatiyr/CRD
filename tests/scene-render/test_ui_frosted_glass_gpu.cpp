...
#include "../gpu-shared/quad_scene_fixture.hpp"   // CEIR-31b-4-b-iii: build_quad_mesh_crdr + write_one_pack (the geometry hard-edge)
#include "../gpu-shared/ui_tint_noise_oracle.hpp" // CEIR-31b-4-b-ii-2 arm (e): ref_hash + noise_from_hash_f32, shared with the eval gate
