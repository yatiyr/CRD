...
TEST_CASE("Chebyshev-PCG converges on an SPD system and beats unpreconditioned CG",
          "[hesap-iterative][chebyshev]")
{
    crd::jobs::init();
    {
...
TEST_CASE("Chebyshev higher degree => stronger preconditioner (fewer outer iters)",
          "[hesap-iterative][chebyshev]")
{
    crd::jobs::init();
    {
        ...
        const auto i2 = iters(2), i6 = iters(6);
