// tests/assets/cooker/test_audio_cook.cpp — GEO-10: a real .flac cooks through the REAL handler into 'ABUF', loads
...
crd::memory::GrowableTlsfAllocator g_alloc{crd::usize{64} << 20U, nullptr, "audio_cook-tests"};
