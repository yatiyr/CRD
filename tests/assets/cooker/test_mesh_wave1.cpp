// tests/assets/cooker/test_mesh_wave1.cpp — GEO-1: the Wave-1 (.stl/.obj/.ply) mesh cook handler gates. Real temp files cook
...
// ── binary STL fixture (mirrors tests/assets/asset-io) ────────────────────────────────────────────────────────────────────────
