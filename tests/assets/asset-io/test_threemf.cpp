...
TEST_CASE("3mf: a REAL reference-producer file imports -- the lib3mf fixture through our ZIP + parser",
          "[assetio][threemf]")
{
    // tests/assets/asset-io/data/lib3mf_box.3mf was authored by lib3mf 2.5.0 (the 3MF Consortium's REFERENCE library, the
...
TEST_CASE("3mf: a REAL slicer-authored file imports -- PrusaSlicer 2.9.6's own re-export of OUR tetra",
          "[assetio][threemf]")
{
    // tests/assets/asset-io/data/prusaslicer_tetra.3mf: PrusaSlicer 2.9.6 loaded OUR exported tetra (after slicing it to
