...
[[nodiscard]] crd::renderer::MeshResource make_plane(
...
[[nodiscard]] crd::renderer::MeshResource make_box(
    crd::memory::IAllocator* a,
    float                    width  = 1.0F,
    float                    height = 1.0F,
    float                    depth  = 1.0F);

[[nodiscard]] crd::renderer::MeshResource make_sphere(
    crd::memory::IAllocator* a,
    float                    radius     = 1.0F,
    crd::u32                 lat_bands  = 16U,
    crd::u32                 lon_bands  = 32U);

[[nodiscard]] crd::renderer::MeshResource make_icosphere(
    crd::memory::IAllocator* a,
    float                    radius       = 1.0F,
    crd::u32                 subdivisions = 2U);

[[nodiscard]] crd::renderer::MeshResource make_cylinder(
    crd::memory::IAllocator* a,
    float                    radius = 0.5F,
    float                    height = 1.0F,
    crd::u32                 segs   = 32U);

[[nodiscard]] crd::renderer::MeshResource make_cone(
    crd::memory::IAllocator* a,
    float                    radius = 0.5F,
    float                    height = 1.0F,
    crd::u32                 segs   = 32U);

[[nodiscard]] crd::renderer::MeshResource make_capsule(
    crd::memory::IAllocator* a,
    float                    radius = 0.5F,
    float                    height = 1.0F,
    crd::u32                 segs   = 32U,
...
[[nodiscard]] crd::renderer::MeshResource make_torus(
    crd::memory::IAllocator* a,
    float                    major_r   = 1.0F,
    float                    minor_r   = 0.25F,
