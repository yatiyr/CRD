...
// std::exp / std::log / std::pow inside engine/physics/eylem/** (and later
// engine/numerics/hesap/**) because the C runtime's libm differs across platforms
...
inline constexpr f32 kTau     = 6.28318530717958647693F;  // 2*pi
inline constexpr f32 kHalfPi    = 1.57079632679489661923F;  // pi/2
inline constexpr f32 kQuarterPi    = 0.78539816339744830962F;  // pi/4
inline constexpr f32 kInvPi  = 0.31830988618379067154F;  // 1/pi
inline constexpr f32 kInvTwoPi = 0.15915494309189533577F;  // 1/(2*pi)

inline constexpr f32 kE         = 2.71828182845904523536F;
inline constexpr f32 kLn2       = 0.69314718055994530942F;
inline constexpr f32 kInvLn2   = 1.44269504088896340736F;  // 1/ln(2) = log2(e)
inline constexpr f32 kLn10      = 2.30258509299404568402F;
inline constexpr f32 kInvLn10  = 0.43429448190325182765F;  // 1/ln(10) = log10(e)
...
inline constexpr f64 kPiF64      = 3.14159265358979323846;
inline constexpr f64 kTauF64     = 6.28318530717958647693;
inline constexpr f64 kHalfPiF64   = 1.57079632679489661923;
inline constexpr f64 kQuarterPiF64   = 0.78539816339744830962;
inline constexpr f64 kInvPiF64  = 0.31830988618379067154;
inline constexpr f64 kEF64       = 2.71828182845904523536;
inline constexpr f64 kLn2F64    = 0.69314718055994530942;
inline constexpr f64 kInvLn2F64 = 1.44269504088896340736;
inline constexpr f64 kLn10F64   = 2.30258509299404568402;
inline constexpr f64 kInvLn10F64 = 0.43429448190325182765;
