...
// Pattern matches `engine/geometry/geometry-bvh/src/bvh_build_internal.hpp` (the v1f
...
inline constexpr crd::u32 kNullTri = std::numeric_limits<crd::u32>::max();

struct Tri
{
    crd::u32 v[3]   = {0, 0, 0};
    crd::u32 nbr[3] = {kNullTri, kNullTri, kNullTri};
    crd::u8  alive  = 0U;
};
                       ...
                       crd::memory::IAllocator*                          alloc)
{
    ...
    return new_tris.empty() ? kNullTri : new_tris[0];
}
