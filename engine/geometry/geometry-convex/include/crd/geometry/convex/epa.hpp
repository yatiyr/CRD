...
template <MathScalar T> struct EpaResult
{
    ...
    crd::u32 face_vidx_a[3]{kInvalidVertex, kInvalidVertex, kInvalidVertex};
    crd::u32 face_vidx_b[3]{kInvalidVertex, kInvalidVertex, kInvalidVertex};
                                                  ...
                                                  const GjkSimplex<T>& starting_simplex) noexcept
{
    ...
    for (crd::u8 iter = 0; iter < k_max_iter; ++iter)
    {
        ...
        if (new_idx_us >= detail::kEpaMaxVertices)
        {
